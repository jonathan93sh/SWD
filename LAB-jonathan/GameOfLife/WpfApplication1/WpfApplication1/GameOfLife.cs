...
namespace GameOfLife
{
    ...
    class GameOfLife
    {
        ...
        private uint[] _2dArray;
        private int _countDown;

        private IViewer _view;

        public GameOfLife(int gridSize, int runSteps = -1, IViewer view = null)
        {
            _view = view;
            _countDown = runSteps;
            _gridSize = gridSize;
            ...
            _2dArray = new uint[_gridSize * _gridSize];
            view.setRes(gridSize, gridSize);
            view.setDataArray(_2dArray);
        ...
        private void updateView()
        {
            ...
            for (var row = 0; row < _gridSize; row++)
            {
                for (var col = 0; col < _gridSize; col++)
                {
                    ...
                    _2dArray[i] = (uint)_newGrid[row, col];
                }
            }
            _view.update();
